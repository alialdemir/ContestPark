...
{
    public class Mission22 : EfEntityRepositoryBase<Duel>, IMission// Oynadığın herhangi bir kategori sıralamasında 1. 2. veya 3. olmalısın
    {
        public Mission22(IDbFactory dbFactory)
            : base(dbFactory)
        {
        }
        ...
        public Entities.Enums.Missions Mission
        {
            get
            {
                return Entities.Enums.Missions.Mission22;
            }
        }

        /// <summary>
        /// Herhangi bir kategori sıralamasında 2. olmalısın.
        /// </summary>

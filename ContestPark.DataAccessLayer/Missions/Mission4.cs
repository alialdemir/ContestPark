...
{
    public class Mission4 : EfEntityRepositoryBase<Duel>, IMission
    {
        public Mission4(IDbFactory dbFactory)
            : base(dbFactory)
        {
        }
        ...
        public Entities.Enums.Missions Mission
        {
            get
            {
                return Entities.Enums.Missions.Mission4;
            }
        }

        /// <summary>
        /// 100 düello tamamlamalısın.
        /// </summary>

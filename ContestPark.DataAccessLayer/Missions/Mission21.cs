...
{
    public class Mission21 : EfEntityRepositoryBase<Duel>, IMission// Oynadığın herhangi bir kategori sıralamasında 1. 2. veya 3. olmalısın
    {
        public Mission21(IDbFactory dbFactory)
            : base(dbFactory)
        {
        }
        ...
        public Entities.Enums.Missions Mission
        {
            get
            {
                return Entities.Enums.Missions.Mission21;
            }
        }

        /// <summary>
        /// Herhangi bir kategori sıralamasında 3. olmalısın.
        /// </summary>
        ...
        public bool MissionComplete(string userId)
        {
            var _contestStartAndEndDate = DbContext
                  ...
                  .Take(1)
                  .FirstOrDefault();
            List<int> subCategoryIdList = DbContext.Set<Duel>()//Kullanıcının oynadığı kategoriler

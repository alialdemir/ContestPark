...
{
    public class Mission3 : EfEntityRepositoryBase<Duel>, IMission
    {
        public Mission3(IDbFactory dbFactory)
            : base(dbFactory)
        {
        }
        ...
        public Entities.Enums.Missions Mission
        {
            get
            {
                return Entities.Enums.Missions.Mission3;
            }
        }

        /// <summary>
        /// 50 düello tamamlamalısın.
        /// </summary>

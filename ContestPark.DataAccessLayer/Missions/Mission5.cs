...
{
    public class Mission5 : EfEntityRepositoryBase<Duel>, IMission
    {
        public Mission5(IDbFactory dbFactory)
            : base(dbFactory)
        {
        }
        ...
        public Entities.Enums.Missions Mission
        {
            get
            {
                return Entities.Enums.Missions.Mission5;
            }
        }

        /// <summary>
        /// 200 düello tamamlamalısın.
        /// </summary>
